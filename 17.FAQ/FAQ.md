...
# CDN
内容分发网络（CDN）(Content Delivery Network)是一种分布式网络架构，它通过在全球各地部署多个服务器节点，将网站或应用的内容分发到这些节点上。
这种服务的目的是为了提高用户访问网站或应用的响应速度和稳定性，减少网络拥塞，并在一定程度上提高网站的可靠性和安全性。

![./img/cdn_01.png](./img/cdn_01.png)
