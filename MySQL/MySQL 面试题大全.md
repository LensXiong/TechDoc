...
1、 一条SQL查询语句是如何执行的？如果查询不存在的字段，是在哪个阶段报的错？![image-20210327112322352](MySQL 面试题大全.assets/image-20210327112322352.png)

[基础架构：一条SQL查询语句是如何执行的？](https://time.geekbang.org/column/article/115537)

![img](MySQL 面试题大全.assets/0d2070e8f84c4801adbfa03bda1f98d9.png)
...
![image-20210319151349090](MySQL 面试题大全.assets/image-20210319151349090.png)
...
![img](MySQL 面试题大全.assets/2e5bff4910ec189fe1ee6e2ecc7b4bbe.png)
...
![index-optimization-03](MySQL 面试题大全.assets/03.jpg)
...
![index-optimization-04](MySQL 面试题大全.assets/04.jpg)
...
![image-20210320180401124](MySQL 面试题大全.assets/image-20210320180401124.png)

`ref`：该字段显示索引的哪一列被使用了，有可能为一个常量。简单来讲，就是指哪些列或常量被用于查找索引列上的值。	

![image-20210320180517571](MySQL 面试题大全.assets/image-20210320180517571.png)

`rows`：根据表统计信息及索引选用情况，大致估算出最终找到所需记录需要读取的行数。

![image-20210320180557718](MySQL 面试题大全.assets/image-20210320180557718.png)
...
![image-20210320180800151](MySQL 面试题大全.assets/image-20210320180800151.png)
...
![七种SQL Joins 文氏图解](MySQL 面试题大全.assets/02.png)
...
![image-20210326100929697](MySQL 面试题大全.assets/image-20210326100929697.png)

![image-20210325110532167](MySQL 面试题大全.assets/image-20210325110532167.png)



![image-20210326104727264](MySQL 面试题大全.assets/image-20210326104727264.png)
...
![b+树](MySQL 面试题大全.assets/7af22798.jpg)
...
![image-20210325111446388](MySQL 面试题大全.assets/image-20210325111446388.png)
...
![image-20210326103241266](MySQL 面试题大全.assets/image-20210326103241266.png)
...
![image-20210326110644455](MySQL 面试题大全.assets/image-20210326110644455.png)
...
![image-20210326111709336](MySQL 面试题大全.assets/image-20210326111709336.png)
...
![img](MySQL 面试题大全.assets/ce9bedd0dc9013e14e5f450e2149704bef5.jpg)

![img](MySQL 面试题大全.assets/59066cb190ec7579c34e2cd77a1f47e8b68.jpg)
