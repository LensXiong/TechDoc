...
3、请简要说明下你所知道的 `HTTP` 主要请求方法，至少五种？

4、请阐述下 `HTTP` 状态码的分类及常用的`HTTP`状态码，至少七种？

5、简单介绍下你所了解的 `HTTP` 请求头。

6、简单介绍下你所了解的 `HTTP` 响应头?

7、一次完整的 `HTTP` 请求是如何进行的？
...
![image-20210328213844917](网络协议面试大全.assets/image-20210328213844917.png)
